...
import markdownContent from "../../public/markdown/online_dicom_viewer";
import "../markdown.css";
            ...
            <div className="flex relative">
              <div className="flex-1 relative z-20">
                <div className="pr-8 pt-60 pb-20">
                  ...
                  >
                    <p className="text-7xl">Online DICOM Viewer Overview</p>
                  </motion.div>
                  <motion.p
                  ...
                  >
                    Read more about how my Online DICOM Viewer and what inspired
                    its creation.
                  </motion.p>
                  <motion.button
