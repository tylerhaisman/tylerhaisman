...
# About the Author
This project was developed by Tyler Haisman, a computer science student aspiring to work in bioinformatics. For inquiries or collaborations, please contact me by clicking on the "CONTACT" button in the header.
`;
